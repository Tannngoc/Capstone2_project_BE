...
def fetch_stock_data(ticker):
    ...
    while attempt < 3:
        try:
            ...
            # Đặt auto_adjust theo ý muốn (True hoặc False)
            new_data = yf.download(ticker, period='10y', interval='1d', auto_adjust=True)
            ...
            print(f"Lỗi chi tiết: {str(e)}")  # In chi tiết lỗi để dễ debug hơn
